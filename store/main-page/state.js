export default () => ({
  result: {
    ...
    description: 'Подбор жилья в аренду по персональным предпочтениям из вариантов. Квартиры, комнаты, дома, таунхаусы, отели, кемпинги и другое жильё посуточно и на длительный срок.',
    header: 'Путеводитель по твоим правилам',
    mainText: 'Путеводитель по твоим правилам',
    keywords: `жильё, квартира, дом, отель, гостиница, снять, аренда, посуточно, путешествия, достопримечательности, крым, россия,`,
