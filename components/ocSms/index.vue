<template>
  <div>
    <p
      class="p-sms"
    >
      {{ recovery ? 'Для восстановления доступа введите код из смс' : 'Введите код из смс отправленного на номер' }} <br> {{ recovery ? 'отправленного на номер' : '' }} <nobr><b>+7 {{ phone }}</b></nobr>
    </p>
